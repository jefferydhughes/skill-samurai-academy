...
export default function Layout({ children, currentPageName }) {
  ...
  // Don't show layout on landing page and lesson pages
  if (currentPageName === 'Home' || currentPageName === 'KitsuneLesson2D') {
    return children;
  }
  ...
  const getNavItems = () => {
    ...
    return [
      { name: 'Home', page: 'Home', icon: Home, emoji: '🏠' },
      ...
      { name: 'Progress', page: 'ParentProgress', icon: Rocket, emoji: '🎮' },
